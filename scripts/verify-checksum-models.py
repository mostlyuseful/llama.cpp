...
print("filename".ljust(40) + "valid checksum".center(20) + "file missing".center(20)) # noqa: T201
print("-" * 80) # noqa: T201

# Output the results as a table
for r in results:
    print(f"{r['filename']:40} {r['valid checksum']:^20} {r['file missing']:^20}") # noqa: T201
