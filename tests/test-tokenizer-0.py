...
print('tokenizing file: ', fname_tok) # noqa: T201
...
with open(fname_tok, 'r', encoding='utf-8') as f:
    ...
    t_end = time.time()
    print('\nmain : tokenized in', "{:.3f}".format(1000.0 * (t_end - t_start)), 'ms (py)') # noqa: T201
    with open(fname_out, 'w', encoding='utf-8') as f:
        for x in res:
            ...
            f.write(str(x) + '\n')
    print('len(res): ', len(res)) # noqa: T201
    print('len(lines): ', len(lines)) # noqa: T201
print('results written to: ', fname_out) # noqa: T201
